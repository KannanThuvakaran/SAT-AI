...
parser.add_argument('--ckpt_path',  type=str,
                    help='ckpt path', default='./log/soba.pth')
parser.add_argument('--config_path',  type=str,
                    help='config path', default='soba')
parser.add_argument('--pred_save_path',  type=str,
                    help='pred save path', default='./log/soba/test_2.json')

args = parser.parse_args("") # quotation mark needed to work
...
def predict(ckpt_path, config_path='soba', pred_save_path='./log/'):
